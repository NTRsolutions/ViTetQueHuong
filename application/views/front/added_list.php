<ul  class="mini-cart-list">
    <li>
        <a href="<?php echo base_url(); ?>index.php/home/cart_checkout">Giỏ hàng của bạn
                ...
                foreach ($carted as $items) {
                    ...
                    <li>
                        ...
                        <div class="overflow-h">
                            ...
                            <br>
                            <small><?php echo translate('tax'); ?>: <?php echo currency(); ?><?php echo $tax_n = $this->cart->format_number($items['tax'] * $items['qty']);
            $tax += $tax_n;
                    ?></small>
                            <br>
                                <?php if ($this->crud_model->get_type_name_by_id('business_settings', '3', 'value') == 'product_wise') { ?>
                                <small><?php echo translate('shipping'); ?>: <?php echo currency(); ?><?php echo $shipping_n = $this->cart->format_number($items['shipping']) * $items['qty'];
                        $shipping += $shipping_n;
                        ?></small>
                                <br>
