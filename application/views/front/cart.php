                            ...
                            <table class="table" style="border: 1px solid #ddd;">
                                ...
                                <?php foreach ($carted as $items){ ?>
                                    ...
                                    <tr data-rowid="<?php echo $items['rowid']; ?>" >
                                        <td class="product-in-table" style="width: 200px;">
                                            <img class="img-responsive" src="<?php echo $items['image']; ?>" alt="">
                                            <div class="product-it-in">
                                               
                                            </div>    
                                        </td>
                                        <td class="shop-product" style="width: 300px;">
                                             <h3><?php echo $items['name']; ?></h3>
                                        </td>
                                        <td class="pric" style="width: 100px;"><?php echo currency().$this->cart->format_number($items['price']); ?></td>
                                        <td >
                                            <?php
                                                if(!$this->crud_model->is_digital($items['id'])){
                                            ?>
                                                <button type='button' class="quantity-button minus" value='minus' onclick='javascript: document.getElementById("qty").value--;'>-</button>
                                                ...
                                                <button type='button' class="quantity-button plus" value='plus' onclick='javascript: document.getElementById("qty").value++;'>+</button>
