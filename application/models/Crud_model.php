...
class Crud_model extends CI_Model {
    ...
    //GET PRODUCT LINK
    function product_link($product_id, $category) {
            $name = url_title($this->crud_model->get_type_name_by_id('product', $product_id, 'title'));
            return base_url() . 'index.php/home/product_view/' . $product_id . '/' . $category;
    }

//    GET CATEGORY LINK
    function category_link($category_id) {
        return base_url() . 'index.php/home/shop/' . $category_id;
    }
