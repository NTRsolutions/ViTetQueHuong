...
class Home extends CI_Controller {
    ...
    public function gioithieu() {
        $page_data['page_name'] = "gioithieu";
        $page_data['page_title'] = translate('gioi-thieu');
        $this->load->view('front/index', $page_data);
    }
    ...
    public function shop($category_id) {
        ...
        $most_popular = $this->crud_model->Show_all_products();
...
//        $config['base_url'] = base_url() . 'index.php?home/shop1/';
//        $config['per_page'] = 2;
//        $config['num_links'] = 7;
...
//        $page_data['page_name'] = "shop2";
//        $page_data['page_title'] = translate('shop2');
...
//    }
    ...
    public function dangki() {
        $page_data['page_name'] = "dangki";
        $page_data['page_title'] = translate('dangki');
        $this->load->view('front/index', $page_data);
    }
...
//
//    public function shop1($para1 = "", $para2 = "", $min = "", $max = "", $text = '') {
//        $this->load->library('Ajax_pagination');
//        
//        if ($para2 == "") {
...
//    }
    ...
    function listed($para1 = "", $para2 = "", $para3 = "") {
        ...
        if ($para1 == "click") {
            ...
            $page_data['all_products'] = $this->db->get('product')->result();
        }
    ...
    function product_view($para1 = "",$para2 = "") {
        ...
        $product_relate = $this->db->get_where('product', array(
            'category' => $para2,
            'status' => 'ok'
        ));
        ...
        $page_data['product_data'] = $product_data->result_array();
        $page_data['product_relate'] = $product_relate->result_array();
        $page_data['page_title'] = $product_data->row()->title;
        $page_data['product_tags'] = $product_data->row()->tag;

        $most_popular = $this->crud_model->Show_all_products();
        $page_data['most_popular'] = $most_popular;
...
//    test login
    function login_test($para1 = "", $para2 = "") {
        $link = basename("http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]");
        $page_data['page_name'] = $link;
        $this->load->library('form_validation');
        if ($para1 == "do_login") {
            $this->form_validation->set_rules('email', 'Email', 'required');
            $this->form_validation->set_rules('password', 'Password', 'required');
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($safe == 'yes') {
                    ...
                    if ($this->input->post('password1') == $this->input->post('password2')) {
                        ...
                        redirect(base_url() . 'index.php/home/success_regi', 'refresh'); //sucess
                    }
                } else {
                    echo 'Disallowed charecter : " ' . $char . ' " in the POST';
                }
    ...
    function success_regi() {
        $page_data['page_name'] = "success_regis";
        $page_data['page_title'] = translate('success_regis');
        $this->load->view('front/index', $page_data);
    }
    ...
    function testcart(){
        $page_data['page_name'] = "added_list";
        $page_data['page_title'] = translate('success_regis');
        $this->load->view('front/index', $page_data);
    }
